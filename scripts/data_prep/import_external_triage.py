...
def process_external_triage_dataset(dataset_id, output_path):
    ...
    print(
        f"✅ {len(processed_data)} exemples traités et sauvegardés dans {output_path}"
    )


if __name__ == "__main__":
    process_external_triage_dataset(
        "syntech-ai/medical-triage-500", "data/processed/new_triage_data.jsonl"
    )
