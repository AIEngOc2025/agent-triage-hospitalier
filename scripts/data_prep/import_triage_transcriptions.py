...
def process_triage_transcriptions(input_path, output_path):
    ...
    print(f"✅ {len(processed_data)} exemples de triage_transcriptions traités dans {output_path}")

if __name__ == "__main__":
    process_triage_transcriptions("data/raw/triage_transcriptions.json", "data/processed/triage_transcriptions_processed.jsonl")
