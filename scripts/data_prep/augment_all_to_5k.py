...
if __name__ == "__main__":
    sources = [
        ("data/processed/new_triage_data.jsonl", "data/processed/temp_triage_500_2k.jsonl"),
        ("data/processed/triage_nlie2_processed.jsonl", "data/processed/temp_nlie2_2k.jsonl"),
        ("data/processed/triage_transcriptions_processed.jsonl", "data/processed/temp_transcriptions_2k.jsonl")
    ]
    
    for src, dst in sources:
        augment_to_target(src, dst, 2000)
        
    merge_datasets([s[1] for s in sources], "data/processed/train_sft_final_5k_v2.jsonl", 5000)
