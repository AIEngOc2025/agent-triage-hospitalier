...
def test_agent(query):
    """
    @definition : Tests the agent's response to a given query.
    @args/params : query (str) representing the user input.
    @return : None. Prints the final response of the agent.
    """
...
if __name__ == "__main__":
    test_agent("J'ai une douleur vive au bras gauche et je transpire.")
